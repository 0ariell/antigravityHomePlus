        ...
        <div className="max-w-md w-full mx-auto">
          ...
          {step === 'role' ? (
            <>
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-8">¿Cómo quieres usar HomePlus?</p>

              <div className="space-y-4">
                <button
                  onClick={() => handleRoleSelect('CLIENT')}
                  className="w-full p-6 rounded-2xl border-2 border-gray-200 dark:border-gray-700 hover:border-orange-500 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-all group text-left"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-orange-100 dark:bg-orange-900/30 rounded-xl flex items-center justify-center group-hover:bg-orange-200 dark:group-hover:bg-orange-900/50 transition-colors">
                      <UserCircle className="w-7 h-7 text-orange-600 dark:text-orange-400" />
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Soy Cliente</h3>
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="w-14 h-14 bg-amber-100 dark:bg-amber-900/30 rounded-xl flex items-center justify-center group-hover:bg-amber-200 dark:group-hover:bg-amber-900/50 transition-colors">
            ...
            <>
              ...
              <button
                ...
                className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 mb-6 flex items-center gap-1"
              >
                ← Cambiar rol
              </button>
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-8">Completa tus datos para continuar</p>
